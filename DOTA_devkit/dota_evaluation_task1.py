...
def parse_args():
    ...
    parser.add_argument('--detpath', default='/yolov5_obb/runs/val/exp3/last_predictions_Txt_Merged/Task1_{:s}.txt', help='test config file path')
    parser.add_argument('--annopath', default='/dataset/DOTA/dota_v1.5/val/labelTxt/{:s}.txt', help='checkpoint file')
    parser.add_argument('--imagesetfile', default='/dataset/DOTA/dota_v1.5/val/val.txt', help='checkpoint file')
