...
def parse_args():
    ...
    parser.add_argument('--scrpath', default='/yolov5_obb/runs/val/exp3/last_predictions_Txt', help='test config file path')
    parser.add_argument('--dstpath', default='/yolov5_obb/runs/val/exp3/last_predictions_Txt_Merged', help='checkpoint file')
