...
parser.add_argument('--json_path', default='../runs/val/exp3/best_obb_predictions.json',type=str, help="input: coco format(json)")
parser.add_argument('--save_path', default='../runs/val/exp3/last_predictions_Txt', type=str, help="specify where to save the output dir of labels")
